...
namespace ExpenseTracker
{
    public class ExpenseTrackerConstants
    {
        ...
        public const string ExpenseTrackerAPI = "http://expenses-api.azurewebsites.net/";
        ...
        public const string IdSrv = "http://expensesidentityserver.azurewebsites.net/identity";
